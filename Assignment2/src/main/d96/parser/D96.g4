...
withoutASM: manyVariable COLON mptype;
manyVariable: (STATIC_ID|ID) | (STATIC_ID|ID) COMMA manyVariable;
...
withoutASM2: manyVariable2 COLON mptype;
manyVariable2: ID | ID COMMA manyVariable2;
...
classMember:  (constructorDecl|destructorDecl|variableDecl|methodDecl)*;
...
//parameterList: ID manyID COLON mptype manyParam|;
//manyID: COMMA ID manyID|;
//manyParam: SEMI ID manyID COLON mptype manyParam|;
parameterList: manyID COLON mptype manyParam|;
manyParam: SEMI manyID COLON mptype manyParam|;
manyID: ID| ID COMMA manyID;
//lhs
expression_index: (ID|instanceAttr|staticAttr|stmInstanceMethod|stmStaticMethod|instanceCreate|LB expr RB|NULL|literal|SELF) index_operator;
index_operator: LSB expr RSB index_operator|LSB expr RSB;
//
scalar: instanceCreate|ID|SELF|staticAttr|stmStaticMethod|NULL|LB expr RB|literal;
...
instanceMethod: exprInstanceAttr DOT ID LB listOfexpr RB;
stmInstanceMethod: exprInstanceAttr DOT ID LB listOfexpr RB;
//
staticAttr: ID DOUBLE_COLON STATIC_ID;
staticMethod: ID DOUBLE_COLON STATIC_ID LB listOfexpr RB;
stmStaticMethod: ID DOUBLE_COLON STATIC_ID LB listOfexpr RB;
//
lhs: ID|instanceAttr|staticAttr|expression_index;
// All Statement
stmt: (stmt_Assignment|stmt_If|stmt_MethodInvocation|stmt_Break|stmt_Continue|stmt_Return|stmt_ForIn|stmt_block);
stmt_List:(stmt|variableDecl_func)*;
